...
rockPlayer.addEventListener("click", function () {
  ...
  setTimeout(function () {
    rockPlayer.classList.remove("draw");
  }, 300);
});
...
scissorsPlayer.addEventListener("click", function () {
  ...
  setTimeout(function () {
    scissorsPlayer.classList.remove("draw");
  }, 300);
});
...
paperPlayer.addEventListener("click", function () {
  ...
  setTimeout(function () {
    paperPlayer.classList.remove("draw");
  }, 300);
});
...
function game() {
  ...
  function compSign() {
    if (computerSelection == "rock") {
      ...
      setTimeout(function () {
        rockComputer.classList.remove("draw");
      }, 300);
    } else if (computerSelection == "paper") {
      paperComputer.classList.add("draw");
      setTimeout(function () {
        paperComputer.classList.remove("draw");
      }, 300);
    } else if (computerSelection == "scissors") {
      scissorsComputer.classList.add("draw");
      setTimeout(function () {
        scissorsComputer.classList.remove("draw");
      }, 300);
    }
  }
